...
df1 = pd.read_csv(os.path.join("fourier", "glob_flow_fourier_decomposition_blackman_mini.csv"), encoding="latin-1")
print(df1)
...
# 318 - 5980
# 198 - 317
loop = tqdm.tqdm(total=(317-198) * (upperBound - 318))
dataDict = {}
for index1 in range(198, 317):
...
outDf.to_csv("correlations_between_fourier_and_cat_chars_mini.csv")
